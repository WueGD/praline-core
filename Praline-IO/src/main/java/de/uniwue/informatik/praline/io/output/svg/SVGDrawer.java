...
public class SVGDrawer {
    ...
    public void drawEdgeDirection(SVGGraphics2D g2d, Edge edge) {
        if (!edge.getSimpleEdgeDirection().equals(Edge.Direction.UNDIRECTED)) {
            Point2D arrowHead = new Point2D.Double(), arrowOrigin = new Point2D.Double();
            if (edge.getSimpleEdgeDirection().equals(Edge.Direction.OUTGOING)) {
            ...
            } else if (edge.getSimpleEdgeDirection().equals(Edge.Direction.INCOMING)) {
