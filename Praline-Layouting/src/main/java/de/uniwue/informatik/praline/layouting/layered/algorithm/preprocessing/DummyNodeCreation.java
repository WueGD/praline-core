...
public class DummyNodeCreation {
    ...
    public DummyCreationResult createDummyNodes () {
        ...
        PortSideAssignment paInternal = new PortSideAssignment(sugy);
        paInternal.assignPortsToVertexSides(dummyTurningNodes.keySet());
        paInternal.assignPortsToVertexSides(dummyNodesSelfLoops.keySet());
        paInternal.assignPortsToVertexSides(dummyNodesLongEdges.keySet());
